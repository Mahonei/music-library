...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(MusicManager.Presentation.ASPMVC.MusicLibrary.ExtNetConfig), "Start")]
    ...
    public static class ExtNetConfig 
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                ...
                new { controller = "Music", action = "Index", id = UrlParameter.Optional } // Parameter defaults
            );
        }
